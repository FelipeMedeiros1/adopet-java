...
import medeiros.felipe.adopet.api.repository.AbrigoRepository;
...
public class AbrigoService {
    ...
    public void cadatrar(CadastroAbrigoDto dto) {
        ...
        if (jaCadastrado) {
            throw new ValidacaoExcepetion("Dados já cadastrados para outro abrigo!");
        }
    ...
    public Abrigo carregarAbrigo(String idOuNome) {
        ...
        return optional.orElseThrow(() -> new ValidacaoExcepetion("Abrigo não encontrado"));
    }
